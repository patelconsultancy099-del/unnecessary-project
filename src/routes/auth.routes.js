...
import { forgotPassword, login, logout, me, refresh, register, resetPassword, reauth } from '../controllers/auth.controller.js';
...
router.post('/reauth', requireAuth, [body('password').isString().notEmpty(), validate], reauth);
